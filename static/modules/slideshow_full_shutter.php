<section class="slideshow full shutter">
  <ul class="slides">
    <li>
      <figure>
        <img src="img/slideshow/shutter1.jpg" />
        <figcaption>
          <dl>
    ...
    <li>
      <figure>
        <img src="img/slideshow/shutter2.jpg" />
        <figcaption>
          <dl>
            <dt>Image copyright:</dt>
              <dd>Pete Haughie</dd>
    ...
    <li>
      <figure>
        <img src="img/slideshow/shutter4.jpg" />
        <figcaption>
          <dl>
            <dt>Image copyright:</dt>
              <dd>Pete Haughie</dd>
    ...
    <li>
      <figure>
        <img src="img/slideshow/shutter5.jpg" />
        <figcaption>
          <dl>
            <dt>Image copyright:</dt>
              <dd>Pete Haughie</dd>
      ...
      <audio class="ambient" src="audio/audio2.mp3"></audio>
    </li>
    <li>
      <figure>
        <img src="img/slideshow/shutter6.jpg" />
        <figcaption>
          <dl>
            <dt>Image copyright:</dt>
              <dd>Pete Haughie</dd>
    ...
    <li>
      <figure>
        <img src="img/slideshow/shutter7.jpg" />
        <figcaption>
          <dl>
            <dt>Image copyright:</dt>
              <dd>Pete Haughie</dd>
    ...
    <li>
      <figure>
        <img src="img/slideshow/shutter8.jpg" />
        <figcaption>
          <dl>
            <dt>Image copyright:</dt>
              <dd>Pete Haughie</dd>
    ...
    <li>
      <figure>
        <img src="img/slideshow/shutter9.jpg" />
        <figcaption>
          <dl>
            <dt>Image copyright:</dt>
              <dd>Pete Haughie</dd>
